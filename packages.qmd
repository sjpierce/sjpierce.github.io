...
compendium for my most recently accepted paper [@Eliason-RN8603]. This paper
examined bandemia (elevated counts of band neutrophil cells) in dogs with 
lymphoma after exposure to three different drugs in a multi-agent chemotherapy
protocol. This is currently my most refined, publicly available research 
compendium. It contains the data, the Quarto scripts (with embedded R code) used
to manage and analyze the data, plus the HTML output files showing all 
