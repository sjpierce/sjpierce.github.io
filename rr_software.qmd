...
# RStudio Desktop, version 2024.09.1+394 (or later)
[RStudio Desktop](https://posit.co/products/open-source/rstudio/) 
...
# Quarto, version 1.6.38 (or later) 
...
## Quarto for Windows
You can use this 
[direct link to the Windows installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.6.38/quarto-1.6.38-win.msi). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## Quarto for MacOS
You can use this 
[direct link to the MacOS installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.6.38/quarto-1.6.38-macos.pkg). 

# Git, version 2.47.1.1 (or later)
