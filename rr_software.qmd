...
then *base*, then *Download R-4.4.1 for Windows* or use the 
[direct link to the Windows installer](https://cran.r-project.org/bin/windows/base/R-4.4.1-win.exe). 
...
4.4.1 or later. The best way to do that is to use a script such as
