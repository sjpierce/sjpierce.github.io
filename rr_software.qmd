...
## RTools for Windows, version 4.5 (6691-6492 or later)
...
[direct link to the installer file](https://cran.r-project.org/bin/windows/Rtools/rtools45/files/rtools45-6691-6492.exe). 
Save that installation file to your computer, then run it. 
...
# RStudio Desktop, version 2026.01.0+392 (or later)
[RStudio Desktop](https://posit.co/products/open-source/rstudio/) 
...
## RStudio for Windows
You can use this 
[direct link to the Windows installer](https://download1.rstudio.org/electron/windows/RStudio-2026.01.0-392.exe). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## RStudio for MacOS
You can use this [direct link for the MacOS installer](https://download1.rstudio.org/electron/macos/RStudio-2026.01.0-392.dmg).  
...
[direct link for the Windows installer](https://github.com/git-for-windows/git/releases/download/v2.53.0.windows.1/Git-2.53.0.1-64-bit.exe). 
