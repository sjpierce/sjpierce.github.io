...
## RTools for Windows, version 4.4 (6414-6401 or later)
...
[direct link to the installer file](https://cran.r-project.org/bin/windows/Rtools/rtools44/files/rtools44-6414-6401.exe). 
Save that installation file to your computer, then run it. 
...
[direct link for the Windows installer](https://github.com/git-for-windows/git/releases/download/v2.48.1.windows.1/Git-2.48.1-64-bit.exe). 
