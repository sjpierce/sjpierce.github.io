...
# RStudio Desktop, version 2025.09.2+418 (or later)
[RStudio Desktop](https://posit.co/products/open-source/rstudio/) 
...
## RStudio for Windows
You can use this 
[direct link to the Windows installer](https://download1.rstudio.org/electron/windows/RStudio-2025.09.2-418.exe). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## RStudio for MacOS
You can use this [direct link for the MacOS installer](https://download1.rstudio.org/electron/macos/RStudio-2025.09.2-418.dmg).  
