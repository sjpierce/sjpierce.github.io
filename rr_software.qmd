...
want to see how I use these software tools, check out my upcoming 
presentation on reproducible research [@Pierce-RN8692]. 
...
then *base*, then *Download R-4.4.3 for Windows* or use the 
[direct link to the Windows installer](https://cran.r-project.org/bin/windows/base/R-4.4.3-win.exe). 
