...
# Quarto, version 1.9.36 (or later) 
...
## Quarto for Windows
You can use this 
[direct link to the Windows installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.9.36/quarto-1.9.36-win.msi). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## Quarto for MacOS
You can use this 
[direct link to the MacOS installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.9.36/quarto-1.9.36-macos.pkg). 
