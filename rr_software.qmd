...
then *base*, then *Download R-4.6.1 for Windows* or use the 
[direct link to the Windows installer](https://cran.r-project.org/bin/windows/base/R-4.6.1-win.exe). 
...
# RStudio Desktop, version 2026.07.1+147 (or later)
[RStudio Desktop](https://posit.co/products/open-source/rstudio/) 
...
## RStudio for Windows
You can use this 
[direct link to the Windows installer](https://download1.rstudio.org/electron/windows/RStudio-2026.07.1-147.exe). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## RStudio for MacOS
You can use this [direct link for the MacOS installer](https://download1.rstudio.org/electron/macos/RStudio-2026.07.1-147.dmg).  

# Quarto, version 1.9.38 (or later) 
...
## Quarto for Windows
You can use this 
[direct link to the Windows installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.9.38/quarto-1.9.38-win.msi). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## Quarto for MacOS
You can use this 
[direct link to the MacOS installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.9.38/quarto-1.9.38-macos.pkg). 

# Git, version 2.55.0.3 (or later)
...
[direct link for the Windows installer](https://github.com/git-for-windows/git/releases/download/v2.55.0.windows.3/Git-2.55.0.3-64-bit.exe). 
