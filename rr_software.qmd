...
research can be facilitated by using a set of software packages that
combine into a powerful, integrated set of tools. The statistical software
...
website, or srt of presentation slides complete with text, equations, figures, 
...
Marwick, Boettiger, & Mullen [-@Marwick-RN3899] discuss creating research
compendiums that bundle collections of documents along with data files into
custom R packages to make a research project more reproducible. These software
packages become additional scholarly products that make manuscripts more
reproducible.
...
environment that I rely on for my daily research and statistical work. 
...
then *base*, then *Download R 4.4.0 for Windows* or use the 
[direct link to the Windows installer](https://cran.r-project.org/bin/windows/base/R-4.4.0-win.exe). 
...
If you previously were using an older version of R (any version in the 4.3.x
series), you should plan to reinstall all your R packages from scratch under R
4.4.0 or later. The best way to do that is to use a script such as
...
## RTools for Windows, version 4.4 (6104-6039 or later)
...
*Download R for Windows*, then *RTools*, then *RTools 4.4*, then 
*RTools44_installer*, or use the 
[direct link to the installer file](https://cran.r-project.org/bin/windows/Rtools/rtools44/files/rtools44-6104-6039.exe). 
Save that installation file to your computer, then run it. 
...
# RStudio Desktop, version 2024.04.2+764 (or later)
[RStudio Desktop](https://posit.co/products/open-source/rstudio/) 
...
## RStudio for Windows
You can use this 
[direct link to the Windows installer](https://download1.rstudio.org/electron/windows/RStudio-2024.04.2-764.exe). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## RStudio for MacOS
You can use this [direct link for the MacOS installer](https://download1.rstudio.org/electron/macos/RStudio-2024.04.2-764.dmg).  

# Quarto, version 1.4.555 (or later) 
...
## Quarto for Windows
You can use this 
[direct link to the Windows installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.4.555/quarto-1.4.555-win.msi). 
Save that installation file to your computer’s `Downloads` folder, then run it.

## Quarto for MacOS
You can use this 
[direct link to the MacOS installer](https://github.com/quarto-dev/quarto-cli/releases/download/v1.4.555/quarto-1.4.555-macos.pkg). 

# Git, version 2.45.2.1 (or later)
...
[direct link for the Windows installer](https://github.com/git-for-windows/git/releases/download/v2.45.2.windows.1/Git-2.45.2-64-bit.exe). 
